...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'LearnEver'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _randKG(List<String> knowledgeList) {
    Random rand = Random();
    int randIndex = rand.nextInt(knowledgeList.length);
    return knowledgeList[randIndex];
  }
